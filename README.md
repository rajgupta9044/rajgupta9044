...
| 🏢 Society Hub Management Platform | 🍔 Swiggy-Inspired Food App |
|---|---|
| MERN Stack platform with Smart Entry & RBAC handling 100+ profiles | High-performance React app utilizing Swiggy Live APIs |
| ⚡ Reduced visitor check-in time by 60% via QR/OTP | 🚀 40% faster load with Shimmer UI & Redux Toolkit |
| 💳 Internal Marketplace with UPI/COD & automated Due Payments | 🔗 Bypassed CORS with proxy servers & 15% CSS bundle reduction |
...
🥇 **Top 5** — Innotech Department-Level Hackathon (Out of 50+ Teams)  
💼 **Web Dev Coordinator** — Managed 5+ hackathons & taught 30+ juniors at CPBYTE Club  
✅ **AMCAT Qualified** — Secured 550+ marks with top-tier percentiles  
🏅 **AWS Certified Cloud Practitioner**  
🎓 **Introduction to MongoDB** & **Full Stack Web Development** Certifications  
...
<!-- Snake auto-updates daily via GitHub Actions — setup snake.yml -->
<picture>
